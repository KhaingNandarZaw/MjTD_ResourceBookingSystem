    ...
    <div class="bg-primary clearfix">
        <div class="col-md-4">
            <div class="row">
                ...
                <div class="col-md-9">
                    <h4 class="name">{{ $car_request->$view_col }}</h4>
                    <div class="row stats">
        ...
        <div class="col-md-1 actions">
            @la_access("Car_Requests", "edit")
                <a href="{{ url(config('laraadmin.adminRoute') . '/car_requests/'.$car_request->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
            @endla_access
            
            @la_access("Car_Requests", "delete")
                {{ Form::open(['route' => [config('laraadmin.adminRoute') . '.car_requests.destroy', $car_request->id], 'method' => 'delete', 'style'=>'display:inline']) }}
