    ...
    {!! Form::open(['action' => 'CarRequests_approveController@list_filter', 'method' => 'POST']) !!}
        <div class="row form-group">
            ...
            <div class="col-sm-2">
                ...
                <div class="input-group date"><input class="form-control input-sm" placeholder="Enter From Date" data-rule-minlength="0" id="from_date" name="from_date" type="text" value=""><span class="input-group-addon input_dt"><span class="fa fa-calendar"></span></span></div>
            </div>
            <div class="col-sm-2">
                <label>To Date</label>
			...
			<div class="modal-body">
                <div class="box-body">
                    ...
                    <div class="form-group">
						...
						<input type="text" placeholder="Car Number" name="car_number" class="form-control">
					</div>
                    <div class="form-group">
